...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      <Card.Body>
        <div>
        <h2>Ajouter à la Flotte Aérienne:{this.state.compter}</h2>          {/*Appelation de notre state du compteur*/}
        ...
        <Card.Title><h3>{this.state.name}</h3></Card.Title>                { /*Appelation de notre state Nom de l'aéronef*/}
        <Card.Text>
        ...
        <Button variant="primary" onClick={this.toggle}>Afficher/Masquer les détails</Button> {/*Créer un boutton où on met une action (au clic:Changer la viibilité de la valeur de la description que l'on a importé depuis Texte.js)*/}
